...
public class MessageConfig extends OkaeriConfig {
    ...
    public String addedBalanceMessage = "&aDodano &2{AMOUNT}zl &ado balansu gracza &2{PLAYER}";
    public String removeBalanceMessage = "&cZabrano &4{AMOUNT}zl &cz balansu gracza &4{PLAYER}";
